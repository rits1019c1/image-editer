import { _ as __vitePreload } from "./index-E0pTKnqK.js";
...
var getOrt = async (useWebGPU) => {
  ...
  if (useWebGPU) {
    ort = (await __vitePreload(async () => {
      const { default: __vite_default__ } = await import("./ort.webgpu.bundle.min-6OwDAiLs.js");
      return { default: __vite_default__ };
    }, true ? [] : void 0, import.meta.url)).default;
  } else {
    ort = (await __vitePreload(async () => {
      const { default: __vite_default__ } = await import("./ort.bundle.min-ZGID3nl7.js");
      return { default: __vite_default__ };
    }, true ? [] : void 0, import.meta.url)).default;
  }
  return ort;
